...
for (int i = 0; i < 500000; i++) {
    obj.push_front(i);  // Push at the front
    obj.push_back(i + 500000);  // Push at the back
}

// Perform 1,000,000 alternating pop operations (front and back)
for (int i = 0; i < 500000; i++) {
    obj.pop_front();  // Pop from the front
    obj.pop_back();   // Pop from the back
}
